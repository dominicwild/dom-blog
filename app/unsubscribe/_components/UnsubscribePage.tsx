...
import {removeEmailSubscription} from "@/server/dynamo";
    ...
    useEffect(() => {
        const processUnsubscribe = async () => {
            try {
                ...
                await removeEmailSubscription(id, email);
                setState("success");
            } catch (error) {
                setState("error");
                ...
                <AnimatePresence mode="wait">
                    {state === "loading" && (
                        ...
                        >
                            ...
                            >
                                Please wait while we remove your email address...
                            </motion.p>
                    ...
                    {state === "error" && (
                        ...
                        >
                            ...
                            <motion.p
                                ...
                                transition={{delay: 0.4, duration: 0.5}}
                            >
                                {errorMessage || "We couldn't remove your subscription."} + {" Please try again or contact dom@dominicwild.com for assistance."}
                            </motion.p>
