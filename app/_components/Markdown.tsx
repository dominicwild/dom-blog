...
const Markdown = ({
    ...
    const markdownComponents: Components = {
        h1: ({node, ...props}) => (
            <h2 className={`text-4xl font-bold mb-2 ${header1ClassName}`} {...props} />
        ),
        h2: ({node, ...props}) => (
            <h3 className="text-3xl font-semibold mt-6 mb-3" {...props} />
        ),
        h3: ({node, ...props}) => (
            <h4 className="text-2xl font-semibold mt-5 mb-2" {...props} />
        ),
        h4: ({node, ...props}) => (
            <h5 className="text-xl font-medium mt-4 mb-2" {...props} />
        ),
        h5: ({node, ...props}) => (
            <h6 className="text-lg font-medium mt-4 mb-2" {...props} />
        ),
        h6: ({node, ...props}) => (
